          ...
          <div className="flex items-center">
            <div className="flex gap-2 justify-center items-center">
              {generatePagination().map((page, index) => {
                if (page === "...") {
                  return (
                    <span key={index} className="text-text-third font-bold">
                      {page}
                    </span>
                  );
                }
                return (
                  <span
                    ...
                    className={`${
                      currentPage === page ? "bg-primary-default text-white" : ""
                    } px-2 py-1 rounded-md border-primary-default border-2 cursor-pointer`}
                  >
                    {page}
                  </span>
                );
